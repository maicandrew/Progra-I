...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname |Maxell 2.0|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
(define (teclado posx posy press ventana img ll lvl)
  ...
  (if (equal? press 'up)
      (if (= (vector-ref (vector-ref matriz (/ (- posy 35) 35)) (/ posx 35)) 1)
          (teclado posx posy (key-value (get-key-press ventana)) ventana img ll lvl)
          (if (= (vector-ref (vector-ref matriz (/ (- posy 35) 35)) (/ posx 35)) 5)
              (begin
                ...
                (teclado posx (- posy 35) (key-value (get-key-press ventana)) ventana img (+ ll 1) lvl)
              )
              (begin
                (vector-set! (vector-ref matriz (/ (- posy 35) 35)) (/ posx 35) 9)
                (limpiar posx posy ventana lvl)
                (nave posx (- posy 35) 'u ventana img)
                (teclado posx (- posy 35) (key-value (get-key-press ventana)) ventana img ll lvl)
              )))
              ...
              (if (= (vector-ref (vector-ref matriz (/ posy 35)) (/ (- posx 35) 35)) 1)
                  ...
                  (if (= (vector-ref (vector-ref matriz (/ posy 35)) (/ (- posx 35) 35)) 5)
                      (begin
                        ...
                        (teclado(- posx 35) posy (key-value (get-key-press ventana)) ventana img (+ ll 1) lvl)
                      )
                      (begin
                        (vector-set! (vector-ref matriz (/ posy 35)) (/ (- posx 35) 35) 9)
                        (limpiar posx posy ventana lvl)
                        (nave (- posx 35) posy 'l ventana img)
                        (teclado(- posx 35) posy (key-value (get-key-press ventana)) ventana img ll lvl)
                      )))
